...
CMD python3 manage.py makemigrations journal && python3 manage.py migrate && cat demo/create_admin.py | python3 manage.py shell && python3 manage.py runserver 127.0.0.1:8001
